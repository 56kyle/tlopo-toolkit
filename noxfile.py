"""Noxfile for the tlopo-toolkit project."""
...
PROJECT_NAME: str = "tlopo-toolkit"
PACKAGE_NAME: str = "tlopo_toolkit"
REPOSITORY_HOST: str = "github.com"
REPOSITORY_PATH: str = "56kyle/tlopo-toolkit"
...
def build_container(session: Session) -> None:
    """Build the Docker container imag.
